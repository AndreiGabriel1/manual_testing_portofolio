...
Created a database named 'orangehrm' and a table named 'JobTitles' with all the columns needed to save data per specifications. Performed different queries inside the sql file:
